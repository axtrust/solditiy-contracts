...
contract AxtrustICO is Ownable {
  string public constant name = "Axtrust ICO";
  using SafeMath for uint256;
  ...
  // how many ETH cost 1000000 AXTP. rate = 1000000 AXTP/ETH. It's always an integer!
  //formula for rate: rate = 1000000 * (AXTP in USD) / (ETH in USD)
  uint256 public rate;
  ...
  uint public constant HARD_CAP_TOKENS = 7105263 * 10**18;
